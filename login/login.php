	...
	<div class="w3ls-pos">
		...
		<div class="w3ls-login box">
			...
			<form class="form loginform" method="POST" action="authenticate.php">
				...
				<a style="color: black;" href="http://localhost/Online-Certificate-Generation-Verification-main/"><button type="button" class="btn btn-outline-danger btn-lg" style="background-color: #F9A826;">Main Site</button></a>
