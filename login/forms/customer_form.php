<fieldset>
    ...
    <div class="form-group">
        <label>State</label>
        <input type="text" name="state" value="<?php echo htmlspecialchars($edit ? $customer['state'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="State" class="form-control selectpicker" id="email" required>
